...
tags:
  ...
  - "AI"
  - "Diagnostics"
description: "Lots of hype about AI so I'd like to offer a step-by-step review of some actual work I did on my open-source project."
---
...
A few Instagram reels later it came with the solution: HTML escaped entities because PowerShell 5.1's encoding is incompatible, and calculating a `Count` differently - I'm sure both of those would have taken me significantly longer to find.
